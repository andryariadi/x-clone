    ...
    <div className="h-screen flex items-center justify-between p-8">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        ...
        <SignUp.Root>
          ...
          {/* SignIn Link */}
          <Link href="/sign-in" className="bg-iconBlue rounded-full p-2 text-white font-bold w-72 text-center">
            Already have an account?
          </Link>

          {/* Terms of Service */}
          <p className="w-72 text-xs">
            By signing up, you agree to the <span className="text-iconBlue">Terms of Service</span> and <span className="text-iconBlue">Privacy Policy</span>, including <span className="text-iconBlue">Cookie Use</span>.
          </p>
        </SignUp.Root>
      </div>
    </div>
